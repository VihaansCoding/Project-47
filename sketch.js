...
function preload(){
  ...
  batAnimation = loadAnimation("assets/bat1.png","assets/bat2.png","assets/bat3.png")
...
textSize(20)
fill("red")
text("Score ="+score,displayWidth-400,displayHeight/2-420)
text("Bullet ="+bullets,displayWidth-400,displayHeight/2-400)
...
bat.addAnimation("flyingBat",batAnimation)
bat.scale = 0.8
bat.velocityX = -3
batGroup.add(bat)
bat.lifetime = 400
